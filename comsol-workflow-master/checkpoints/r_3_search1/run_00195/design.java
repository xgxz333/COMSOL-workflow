...
/** Model exported on Feb 28 2026, 19:04 by COMSOL 6.3.0.335. */
public class design {
  ...
  public static Model run() {
    ...
    model
         .modelPath("/cluster/scratch/jiayli/workspaces/search_runs/r0=0_r=3_theta=None_b0=1_b=None_phi=None_mode=1/search_1/runs/run_00195");
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("pol2")
         .set("table", new String[][]{{"0.06742294343554711 [um]", "0.0 [um]"}, {"0.2669315056496487 [um]", "-0.11518632209994675 [um]"}, {"0.2669315056496487 [um]", "0.11518632209994675 [um]"}});
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("pol3")
         .set("table", new String[][]{{"0.07813998303406243 [um]", "0.13534242071756616 [um]"}, {"0.277648545248164 [um]", "0.2505287428175129 [um]"}, {"0.07813998303406244 [um]", "0.36571506491745964 [um]"}});
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("pol4")
         .set("table", new String[][]{{"-0.0781399830340624 [um]", "0.13534242071756625 [um]"}, {"-0.07813998303406235 [um]", "0.3657150649174597 [um]"}, {"-0.27764854524816396 [um]", "0.250528742817513 [um]"}});
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("pol5")
         .set("table", new String[][]{{"-0.06742294343554711 [um]", "8.256929186743582e-18 [um]"}, {"-0.2669315056496487 [um]", "0.11518632209994678 [um]"}, {"-0.2669315056496487 [um]", "-0.11518632209994673 [um]"}});
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("pol6")
         .set("table", new String[][]{{"-0.07813998303406249 [um]", "-0.13534242071756614 [um]"}, {"-0.2776485452481641 [um]", "-0.25052874281751275 [um]"}, {"-0.0781399830340626 [um]", "-0.3657150649174596 [um]"}});
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("pol7")
         .set("table", new String[][]{{"0.07813998303406243 [um]", "-0.13534242071756616 [um]"}, {"0.07813998303406244 [um]", "-0.36571506491745964 [um]"}, {"0.277648545248164 [um]", "-0.2505287428175129 [um]"}});
